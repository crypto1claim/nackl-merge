...
const TRANSLATIONS = {
  ru: {
    ...
    'menu.qr_hint': 'или отсканируй QR сканером внутри AN Wallet',
    'menu.change_name': '← Ввести другое имя',
    'menu.need_wallet_hint': 'Нужно установленное приложение AN Wallet. Нажми кнопку и подтверди подключение в кошельке:',
    'menu.name_placeholder': 'Имя AN Wallet (например: alice)',
    'menu.stage_hello': 'Ожидаем подтверждение в AN Wallet…',
  ...
  en: {
    ...
    'menu.qr_hint': 'or scan the QR with the scanner inside AN Wallet',
    'menu.change_name': '← Use a different name',
    'menu.need_wallet_hint': 'You need the AN Wallet app installed. Tap the button and confirm the connection in the wallet:',
    'menu.name_placeholder': 'AN Wallet name (e.g. alice)',
    'menu.stage_hello': 'Waiting for confirmation in AN Wallet…',
